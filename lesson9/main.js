...
//
// for   (const simson of simpsons){
//        const mainDiv = document.createElement(`div`);
//        mainDiv.classList.add(`member`);
//        htmlDivElement.appendChild(mainDiv);
//
//        const h2 = document.createElement(`h2`);
//        h2.innerText = `${simson.name} -- ${simson.surname}`;
//        mainDiv.appendChild(h2);
//
//        const  paragraph = document.createElement(`p`);
//        paragraph.innerText = `${simson.age} -- ${simson.info}`;
//        mainDiv.appendChild(paragraph);
//
//        const  image = document.createElement(`img`);
//        image.src = `${simson.photo}`;
...
//
// for (const iter of coursesArray) {
//
...
//
//   const paragraph = document.createElement(`p`);
//   paragraph.style.border = `20px solid darkBlue`;
...
//   paragraph1.style.marginTop = `2px`;
